...
def load_data()->tuple[dict,dict]:
    ...
    # READ CLIENT DATA 
    with open('./data/clients.csv', newline='') as csvfile:
        ...
        for row in reader:
            try:
                ...
                client_listing[client_number] = Client(client_number, 
    ...
    with open('./data/accounts.csv', newline='') as csvfile:
        ...
        for row in reader:
            try:
                ...
                if client_number in client_listing.keys():
