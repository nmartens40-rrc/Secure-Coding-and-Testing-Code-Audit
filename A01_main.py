...
def main():
    ...
    try:
        client = Client(20, "Aiden", "Cameron", "nmartens40@rrc.ca")
    ...
    try:
        bank_account = BankAccount(30, 20, 230.9)
    except Exception as e:
        print(e)
